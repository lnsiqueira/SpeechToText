...
namespace HelloWorld
{
    public class Program
    {
        ...
        static async Task Main()
        {
            ...
            RecognizeSpeechAsyncVoice().Wait();
            Console.WriteLine("Please press <Return> to continue.");
            Console.ReadLine();
        }


        //Escutar dados de tradução de entrada
        public static async Task RecognizeSpeechAsyncVoice()
        {
            var config = SpeechConfig.FromSubscription("xxx", "southcentralus");
    ...
    //Converter Fala de um Arquivo de Áudio em Texto
    static async Task RecognizeSpeechAsync()
        {            
            ...
            using (var audioInput = AudioConfig.FromWavFileInput(@"C:\TEMP\speech\narration.wav"))
